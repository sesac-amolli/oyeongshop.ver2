...
public interface ProductService {
    ...
    void uploadDBForProduct(List<String> imageUrls, Product product); // [상품 등록] 상품 이미지 등록
    List<ProductOptionResponse> findByProdNameOrCodeManagementJPQL(String search); // [상품 관리] 상품명 또는 상품 코드로 상품 목록 검색
