...
public class ProductOptionResponse {
    ...
    public ProductOptionResponse(Long prodId, String prodCode, String prodName, Long prodOriginPrice, Long prodSalesPrice, LocalDateTime prodRegDate, LocalDateTime prodEditDate, String prodCategory,
    ...
    public static ProductOptionResponse from(Product product) {
        ...
        final LocalDateTime prodEditDate = product.getProdEditDate();
        ...
        return new ProductOptionResponse(prodId, prodCode, prodName, prodOriginPrice,prodSalesPrice,prodRegDate,prodEditDate,prodCategory,
